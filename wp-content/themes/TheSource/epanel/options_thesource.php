...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of displayed on Homepage",
...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#recent-posts a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		ul.nav li a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		ul.nav li.current_page_item a, ul.nav li a:hover, #cat-nav-content ul.nav li a:hover, #cat-nav-content ul.nav li.current-cat > a  { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
		...
		p#copyright { color:#<?php echo(get_option($shortname.'_footer_text')); ?> }
		#footer a, ul.bottom-nav li a { color:#<?php echo(get_option($shortname.'_color_footerlinks')); ?> }
	</style>
