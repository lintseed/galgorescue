			...
			<div id="et_pt_blog">
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div class="et_pt_blogentry clearfix">
						...
						<p class="et_pt_blogmeta"><?php _e('Posted','MyProduct'); ?> <?php _e('by','MyProduct'); ?> <?php the_author_posts_link(); ?> <?php _e('on','MyProduct'); ?> <?php the_time(get_option('myproduct_date_format')) ?> <?php _e('in','MyProduct'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(__('0 comments','MyProduct'), __('1 comment','MyProduct'), '% '.__('comments','MyProduct')); ?></p>
						...
						<?php if (!$et_ptemplate_blogstyle) { ?>
							...
							<a href="<?php the_permalink(); ?>" class="readmore"><span><?php _e('read more','MyProduct'); ?></span></a>
						<?php } else { ?>
							<?php the_content(''); ?>
						<?php } ?>
