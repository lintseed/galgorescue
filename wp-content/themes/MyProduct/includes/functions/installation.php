 <span class="boldtext">1. How do I install MyProduct onto my wordpress blog? </span>
<div class="indent">
...
<div class="indent">You can change the images used in each of the advertisements, as well as which URL each ad points to, through the custom option pages found in wp-admin. Once logged in to the wordpress admin panel, click &quot;Design&quot; and then &quot;MyProduct Theme Options&quot; to reveal the various theme options. You can also use the 125x125 advertisement widget by adding the ET: Advertisement widget to your sidebar, and filling in the required fields.  </div>
  ...
  <span class="boldtext">5. How do I create my Blog section? </span>
  <div class="indent">
  <p>Designating a blog category in MyProduct is simple. Open the Appearances &gt; MyProduct Theme Options page in wp-admin and then navigation to the General Settings &gt; General tab (this is the default tab displayed when you load the page). Locate the Blog Category dropdown menu and choose one from the list. The category you choose will become your &quot;Blog&quot; category. It will assume the blog style post layout, it's posts will be added to the homepage in the blog tabbed menu, and a link to the blog category will be added to the navigation bar. </p></div>

  <span class="boldtext">6. How do I set up the featured slider on the homepage? </span>
  <div class="indent">
  <p>The featured slider can be set up using two different methods. You can either popular the tabs using Pages, or you can popular it using posts from a designated category. In the Appearances > MyProduct Theme Options page in wp-admin, under the General Settings > Featured Slider tab, you will see an option that says "Use Pages." If you select this option then pages will be used, if you don't then posts will be used. If you want to use Pages then you simply select "Use Pages," and then below the option select which pages you would like to display in the slider. If you don't use pages, then simply select the "Featured Category" from the dropdown menu and posts from that category will be added to the slider. </p></div>

  
  <span class="boldtext">7. How do I setup the four blurbs on the homepage, below the slider? </span>
  <div class="indent">
  <p>These blurbs are created using pages. Create four pages that you would like to use for these four blurbs, then go to the Appearances > MyProduct Theme Options page and click the General Settings > Homepage tab. Under the Service Page 1/2/3/4 dropdown menus, choose the four pages you would like to use. Witin the pages you can use a "more" tag to truncate the post preview.
</p>
<p>Next you will need to assign an Icon image to each blurb. This works just like Thumbnail images, except you use the custom field name "Icon" instead. So create a custom field for each page with the name of "Icon" and a value of the icon image you would like to use. Icons must not exceed 36x36 pixels to insure optimum display.</p>
  ...
  <span class="boldtext">8. How do I add descriptions to my blog pages/posts? </span>
  <div class="indent">
  <p>Descriptions appear below the title on post/pages. To add this description simply create a custom field for each post/page with the name of "Tagline" and a value of the text you would like to use for the description.
</p>
</div>

  <span class="boldtext">9. How do I add the main header page/yellow buttons on the homepage? </span>
  <div class="indent">
  <p>The main text on the homepage header is page-based, which means you will need to create a page and assign it to this area via ePanel. Once you have created a page, navigate to the Appearances > MyProduct Theme Options page and click on the Homepage tab. Find the "Welcome page" setting and choose your welcome page from the dropdown menu.
...
Next you can add the yellow buttons seen in the demo. This is done using custom fields. To create the first button, add a custom field with the name Button and a value of the text you would like to use for the button. Next create a custom field with the name of Buttonurl, and a value of the URL you would like the user to be taken when clicked. To add a second button, create a Button2 and Button2url custom field. 
  ...
  <span class="boldtext">10. How do I add the tabbed content on the homepage? </span>
  <div class="indent">
  <p>Each of these sections are page-based, which means each tab is a separate page. Simply create a page for each section, then navigate to the Appearances > MyProduc Theme Options page and click on the Featured Slider tab. Here you can choose which pages you would like to use. Alternately you can populate the area using Posts instead of Pages by assigning a featured category. 
</p>
After you choose which pages you would like to use for the tabbed area, you will need to custom the Tab text. To do this add a custom field to each page with the name of Tab and a value of the text you would like to use in the clickable tab for that section. 
</div>