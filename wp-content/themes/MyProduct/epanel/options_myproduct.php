...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#content-left a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		ul.nav li a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		ul.nav a:hover, ul.nav > li.sf-ul > a:hover, ul.nav > li.sf-ul.sfHover > a { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
