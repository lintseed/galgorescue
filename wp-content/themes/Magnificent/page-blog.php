						...
						<div id="et_pt_blog">
							...
							<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
								...
								<div class="et_pt_blogentry clearfix">
									...
									<p class="et_pt_blogmeta"><?php _e('Posted','Magnificent'); ?> <?php _e('by','Magnificent'); ?> <?php the_author_posts_link(); ?> <?php _e('on','Magnificent'); ?> <?php the_time(get_option('magnificent_date_format')) ?> <?php _e('in','Magnificent'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(__('0 comments','Magnificent'), __('1 comment','Magnificent'), '% '.__('comments','Magnificent')); ?></p>
