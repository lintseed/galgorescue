...
load_theme_textdomain('Magnificent',get_template_directory().'/lang');

require_once(TEMPLATEPATH . '/epanel/options_magnificent.php');

require_once(TEMPLATEPATH . '/epanel/core_functions.php'); 

require_once(TEMPLATEPATH . '/epanel/post_thumbnails_magnificent.php');
