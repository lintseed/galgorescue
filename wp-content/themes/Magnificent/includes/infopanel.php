<div class="info-block">
	<h3 class="infotitle"><?php _e('Related Posts','Magnificent'); ?></h3>
	<div class="ul-thumb">
		<?php global $post;
		$orig_post = $post;
				...
				<ul class="related-posts">
					...
					$my_query->the_post(); ?>
						...
						<li class="clearfix">
							...
							<p class="post-info"><?php _e('Posted','Magnificent'); _e(' on '); the_time(get_option('magnificent_date_format')); ?></p>
						</li>
					<?php } ?>
				</ul>
			<?php }
...
<div class="info-block">
	<h3 class="infotitle"><?php _e('Tags','Magnificent'); ?></h3>
...
<div class="info-block last">
	<h3 class="infotitle"><?php _e('Share This','Magnificent'); ?></h3>
